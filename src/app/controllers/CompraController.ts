...
class CompraController {
    ...
    async list(req: Request, res: Response){
        ...
        const lista = await repository.createQueryBuilder('tb_compra').leftJoinAndSelect("tb_compra.itens", "compras").leftJoinAndSelect("tb_compra.jogador", "jogador").getMany();
